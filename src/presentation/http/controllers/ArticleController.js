...
export class ArticleController {
    constructor({ articleUseCases }) {
        this.uc = articleUseCases;
        ['create', 'update', 'remove', 'getById', 'list', 'listPublic', 'readBySlug']
    ...
    async readBySlug(req, res) { return ok(res, await this.uc.readBySlug(req.params.slug)); }
}
